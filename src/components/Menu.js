...
import { HOME_ROUTE, ABOUT_ROUTE, CATEGORIES_ROUTE, SIGN_IN_ROUTE, SIGN_UP_ROUTE } from './constantes/constants';
		...
		<div className={classes.root}>
			...
			<AppBar
				...
				<Toolbar className={classes.toolBar}>
					...
					<ExitToAppOutlinedIcon onClick={onSignout}>Sign Out</ExitToAppOutlinedIcon>
					<IconButton
						color='inherit'
