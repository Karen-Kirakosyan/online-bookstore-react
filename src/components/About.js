        ...
        <div>
          <p className={classes.style}>
            ...
            <p className={classes.text}>
              ...
              the results of the weekend, now for the sake of save life. A lot
              of pain is very important. Sit amet consectetur adipiscing elit
              duis tristique sollicitudin nibh. Diam macenas ultricies mi eget.
              . Who is the author of the elite How the lake hung up the throat
              and sometimes put down the Internet. The earth is annoying now, it
              is not an attraction for the mass nor the public. It's in the
              middle of the ball before it's in place to start.
            </p>
          </p>
        </div>
        <div>
          <p className={classes.pic2Style}>
            ...
            <p className={classes.text}>
              ...
              the main reason is the pain, but I give it time to fall into it
              with some great pain and pain. And not for any scenario. Cras sed
              felis eget velit aliquet lacus est non est.
            </p>
            <img
              alt=""
          ...
          <div>
            <p className={classes.style}>
              ...
              <p className={classes.text}>
                ...
                will not be cured during pregnancy and the bow will not be
                cured. The pain of the venenate bed is great and the pain of the
                ferry is ok. The hairstyle, therefore, is not a warm lion or the
                average person's door is not cushioned.
              </p>
            </p>
          </div>
        </div>
